...
import { EmployeeImportsCleanupScheduler } from "./employee-imports.scheduler.js";
import { EmployeeImportsService } from "./employee-imports.service.js";

@Module({
  imports: [AiModule, AuthModule, BullModule.registerQueue({ name: EMPLOYEE_IMPORT_QUEUE })],
  controllers: [EmployeeImportsController],
  providers: [EmployeeImportsService, EmployeeImportsProcessor, EmployeeImportsCleanupScheduler],
})
