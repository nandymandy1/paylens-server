...
export default registerAs("app", () => ({
  ...
  otelLogsEnabled: process.env.OTEL_LOGS_ENABLED !== "false",
  otelServiceName: process.env.OTEL_SERVICE_NAME ?? "paylens-server",
  otelExporterOtlpEndpoint: process.env.OTEL_EXPORTER_OTLP_ENDPOINT ?? "",
  otelTraceSampleRatio: Number(process.env.OTEL_TRACE_SAMPLE_RATIO ?? 1),
